#!/usr/bin/env python
"""
Clean benchmark for MDP (Markov Decision Process) without pyperformance overhead.
This benchmark simulates a pokemon battle using dynamic programming.
"""
...
class Battle(object):
    ...
    def _getSuccessorsB(self, statep):
        ...
        dist = defaultdict(float)
        for eact, p in [('Water Gun', 64.0 / 130.0),
                        ('Bubblebeam', 66.0 / 130.0)]:
...
def main():
    loops = 10  # This is a heavy benchmark, use fewer loops
    bench_mdp(loops)
